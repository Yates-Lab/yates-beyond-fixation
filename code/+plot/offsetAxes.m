function offsetAxes(ax, yonly, amount)
...
if ~exist('amount', 'var'), amount = 4; end

set(ax, 'TickDir', 'out', 'Box', 'off')

% modify the x and y limits to below the data (by a small amount)
if ~yonly
ax.XLim(1) = ax.XLim(1)-(ax.XTick(2)-ax.XTick(1))/amount;
end
ax.YLim(1) = ax.YLim(1)-(ax.YTick(2)-ax.YTick(1))/amount;
